        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8 lg:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'Collections', 'Shop', 'Best Sellers', 'Gift Hampers', 'Wholesale', 'Bulk Enquiry', 'About Us', 'Contact Us'].map((link) => {
          ...
          {/* Customer Support */}
          <div>
            <h4 className="font-semibold text-base mb-4 text-white">Customer Support</h4>
            <ul className="space-y-2">
              {['FAQ', 'Shipping Information', 'Return Policy', 'Privacy Policy', 'Terms & Conditions'].map((link) => {
                let href = `#${link.toLowerCase().replace(/ /g, '-')}`;
                if (link === 'Privacy Policy') href = '/PrivacyPolicy';
                if (link === 'Terms & Conditions') href = '/TermsAndConditions';
                if (link === 'Return Policy') href = '/ReturnPolicy';
                if (link === 'Shipping Information') href = '/shippingInformation';
          ...
          <div>
            <h4 className="font-semibold text-base mb-4 text-white">Experience Table</h4>
        ...
        <div className="border-t border-white/20 pt-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              <a 
                href="#instagram" 
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-all flex items-center justify-center group hover:scale-110"
              >
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 36 36" fill="none">
              ...
              <a 
                ...
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 transition-all flex items-center justify-center group hover:scale-110"
              >
                <svg className="w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 48 48" fill="none">
