...
const floatingNuts = [
  { src: imgObject, delay: 0, className: "w-[80px] md:w-[110px] top-[10%] -left-[2%] md:left-[5%] rotate-[65deg]" },
  { src: imgObject1, delay: 1, className: "w-[60px] md:w-[80px] bottom-[15%] left-[2%] md:left-[8%] rotate-[32deg]" },
  { src: imgObject, delay: 2, className: "w-[90px] md:w-[110px] top-[10%] right-[0%] md:-right-[2%] rotate-[114deg]" },
  { src: imgObject1, delay: 1.5, className: "w-[60px] md:w-[75px] bottom-[15%] right-[2%] md:right-[5%] rotate-[92deg]" },
];
...
export function GiftHampers() {
  return (
    <section className="relative w-full overflow-hidden bg-white py-20 px-4 md:px-8 font-['Roboto',sans-serif]" id="gift-hampers">
      ...
      <div className="relative w-full max-w-[1512px] mx-auto bg-[#496506] rounded-3xl min-h-[400px] lg:h-[361px] flex flex-col lg:flex-row items-center justify-between overflow-visible">
        ...
        <div className="hidden lg:block absolute left-0 top-0 h-full w-[479px]">
          <svg className="absolute block h-full w-full" fill="none" preserveAspectRatio="none" viewBox="0 0 479 361">
