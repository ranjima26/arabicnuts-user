...
const floatingNuts = [
  { src: imgObject, className: "w-16 md:w-20 top-[10%] left-[8%] rotate-[45deg]", delay: 0 },
  { src: imgObject1, className: "w-12 md:w-16 top-[20%] right-[12%] -rotate-[30deg]", delay: 1 },
  { src: imgObject, className: "w-14 md:w-24 bottom-[25%] left-[12%] rotate-[120deg]", delay: 2 },
  { src: imgObject1, className: "w-10 md:w-14 bottom-[30%] right-[10%] -rotate-[15deg]", delay: 1.5 },
];
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="inline-flex items-center justify-center gap-1.5 bg-[#b5df85] px-4 py-1.5 rounded-[30px] mb-4 shadow-sm">
                  <span className="text-[#65615e] font-bold text-xl md:text-2xl leading-none mt-0.5">{products[activeIndex].rating}</span>
                ...
                >
                  ...
                  <span 
                    className={`text-[11px] sm:text-[13px] md:text-[14px] font-medium text-center leading-[1.2] transition-colors ${
                      isActive ? 'text-[#373737]' : 'text-[#8c8b8a] group-hover:text-[#373737]'
                    }`}
                  >
