        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12 lg:mb-16">
          ...
          <div>
            ...
            <p className="text-white/80 mb-6 leading-relaxed">
              Premium quality dry fruits and nuts delivered fresh to your
              doorstep. Your trusted source for healthy snacking.
            </p>
            ...
            <div className="space-y-4">
              ...
              <a
                href="mailto:support@arabicdryfruits.com"
                className="flex items-center gap-3 text-white/70 hover:text-white transition-colors group"
              >
                <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-white/20 transition-colors">
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <p className="text-sm text-white/70 text-center">
              © 2026 Arabic Dry Fruits. All Rights Reserved. Made with ❤️ in
              India
            </p>
